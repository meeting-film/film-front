      ...
      <div class="rc-form-wrapper">
        ...
        <form @submit.prevent="registerFormSubmit" autocomplete="off">
          ...
          <div class="form-field form-field--mobile" data-before="电话：">
            <i class="icon icon-password"></i>
            <input class="form-control" name="mobile" v-model="form.mobile" v-validate="'required|mobile'" :class="{'form-control': true, 'is-danger': errors.has('mobile') }" type="text" placeholder="手机号">
          ...
          <div class="form-field form-field--mobile" data-before="邮箱：">
            <input class="form-control" name="email" v-model="form.email" v-validate="'required|email'" :class="{'form-control': true, 'is-danger': errors.has('email') }" type="text" placeholder="邮箱">
            <span v-show="errors.has('email')" class="help is-danger">{{ errors.first('email') }}</span>
          </div>
          <div class="form-field form-field--mobile" data-before="地址：">
            <input class="form-control" name="address" v-model="form.address" v-validate="'required|address'" :class="{'form-control': true, 'is-danger': errors.has('address') }" type="text" placeholder="地址">
