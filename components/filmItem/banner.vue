    ...
    <div class="wrapper clearfix">
      <div class="celeInfo-left">
        <div class="avatar-shadow">
          <img class="avatar" :src="filmItem.imgAddress" alt="">
          <div class="movie-ver"></div>
        </div>
      </div>
      <div class="celeInfo-right clearfix">
        <div class="movie-brief-container">
          <h3 class="name">{{filmItem.filmName}}</h3>
          <div class="ename ellipsis">{{filmItem.filmEnName}}</div>
          <ul>
            <li class="ellipsis">{{filmItem.info01}}</li>
            <li class="ellipsis">
              {{filmItem.info02}}
            </li>
            <li class="ellipsis">{{filmItem.info03}}</li>
          </ul>
        </div>
        ...
        <div class="movie-stats-container">
          ...
          <div class="movie-index">
            ...
            <div class="movie-index-content score normal-score">
              <span class="index-left info-num ">
                <span class="stonefont">{{filmItem.score}}</span>
              </span>
              <div class="index-right">
                <div class="star-wrapper">
                  <div class="star-on" style="width:59%;"></div>
                </div>
                <span class="score-num"><span class="stonefont">{{filmItem.scoreNum}}</span></span>
              </div>
            </div>
          </div>
          ...
          <div class="movie-index">
            ...
            <div class="movie-index-content box">
              <span class="no-info">{{filmItem.totalBox}}</span>
            </div>
          </div>
        </div>
