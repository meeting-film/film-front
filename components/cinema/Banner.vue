    ...
    <div class="wrapper clearfix">
      <div class="cinema-left">
        <div class="avatar-shadow">
          <img class="avatar" :src=cinemaInfo.imgUrl>
          <div class="avatar-num">查看全部50张图片</div>
        </div>
      </div>
      <div class="cinema-main clearfix">
        <div class="cinema-brief-container">
          <h3 class="name text-ellipsis">{{cinemaInfo.cinemaName}}</h3>
          <div class="address text-ellipsis">{{cinemaInfo.cinemaAdress}}</div>
          <div class="telphone">电话：{{cinemaInfo.cinemaPhone}}</div>

          <div class="features-group">
            <div class="group-title">影院服务</div>

            <div class="feature">
              <span class="tag ">{{cinemaInfo.cinemaName}}</span>
